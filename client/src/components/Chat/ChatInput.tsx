    ...
    <div className={`thin-scrollbar ${id ? "w-full" : "w-[85%] mx-auto"}`}>
      ...
      <div className="relative w-[75%] mx-auto">
        ...
        <form
          ...
          className="flex px-2"
        >
          <div className="w-full flex flex-col justify-between bg-gray-100 dark:bg-slate-800 rounded-2xl border border-gray-300 dark:border-slate-700 px-2 py-2 shadow-md">
            <Textarea
