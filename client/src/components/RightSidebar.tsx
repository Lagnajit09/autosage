...
export const RightSidebar: React.FC<RightSidebarProps> = ({
  ...
  return (
    <Sheet open={open} onOpenChange={onOpenChange}>
      <SheetContent className="w-80 h-[95%] bg-bg-primary/40 backdrop-blur-2xl border-t border-l border-borders-active/30 rounded-tl-3xl overflow-y-auto top-10">
        <SheetHeader className="mb-6">
          <SheetTitle className="text-sm font-semibold text-text-primary flex items-center">
